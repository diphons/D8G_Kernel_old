 ...
 */
void dm_end_request(struct request *clone, blk_status_t error)
{
...
static void dm_done(struct request *clone, blk_status_t error, bool mapped)
{
	...
	if (unlikely(r == BLK_STS_TARGET && (req_op(clone) == REQ_OP_WRITE_SAME) &&
 ...
 */
void dm_kill_unmapped_request(struct request *rq, blk_status_t error)
{
