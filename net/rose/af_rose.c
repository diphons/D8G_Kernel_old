...
static int __init rose_proto_init(void)
{
	...
	proc_create_seq("rose", S_IRUGO, init_net.proc_net, &rose_info_seqops);
	proc_create_seq("rose_neigh", S_IRUGO, init_net.proc_net,
		    &rose_neigh_seqops);
	proc_create_seq("rose_nodes", S_IRUGO, init_net.proc_net,
		    &rose_node_seqops);
	proc_create_seq("rose_routes", S_IRUGO, init_net.proc_net,
		    &rose_route_seqops);
out:
	return rc;
fail:
