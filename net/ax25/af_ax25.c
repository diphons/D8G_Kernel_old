...
static int __init ax25_init(void)
{
	...
	proc_create_seq("ax25_route", S_IRUGO, init_net.proc_net, &ax25_rt_seqops);
	proc_create_seq("ax25", S_IRUGO, init_net.proc_net, &ax25_info_seqops);
	proc_create_seq("ax25_calls", S_IRUGO, init_net.proc_net,
			&ax25_uid_seqops);
out:
	return rc;
}
