...
static int __init nr_proto_init(void)
{
	...
	proc_create_seq("nr", S_IRUGO, init_net.proc_net, &nr_info_seqops);
	proc_create_seq("nr_neigh", S_IRUGO, init_net.proc_net, &nr_neigh_seqops);
	proc_create_seq("nr_nodes", S_IRUGO, init_net.proc_net, &nr_node_seqops);
out:
	return rc;
fail:
	while (--i >= 0) {
