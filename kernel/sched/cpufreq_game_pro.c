...
/*	Revert "cpufreq: schedutil: stop freq update when not changing" 
...
static struct cpufreq_governor game_pro_gov;
...
#ifdef CONFIG_CPU_FREQ_DEFAULT_GOV_GAME_PRO
...
{
	return cpufreq_register_governor(&game_pro_gov);
}
